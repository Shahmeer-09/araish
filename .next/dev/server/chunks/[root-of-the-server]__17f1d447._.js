...
async function GET() {
    try {
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].siteSettings.findUnique({
            where: {
                key: 'main'
            }
        });
...
async function POST(request) {
    try {
        ...
        const shopNameUrdu = formData.get('shopNameUrdu');
        ...
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].siteSettings.upsert({
            where: {
                key: 'main'
            },
            update: updateData,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__17f1d447._.js.map