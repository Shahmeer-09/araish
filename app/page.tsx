  ...
  return (
    <div className="min-h-screen bg-[var(--background)]" suppressHydrationWarning>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-8 left-8 w-24 h-24 border-t-2 border-l-2 border-[var(--gold)]/40 animate-fade-in opacity-0 delay-700" style={{ animationFillMode: 'forwards' }} />
        <div className="absolute top-8 right-8 w-24 h-24 border-t-2 border-r-2 border-[var(--gold)]/40 animate-fade-in opacity-0 delay-700" style={{ animationFillMode: 'forwards' }} />
        <div className="absolute bottom-8 left-8 w-24 h-24 border-b-2 border-l-2 border-[var(--gold)]/40 animate-fade-in opacity-0 delay-700" style={{ animationFillMode: 'forwards' }} />
        <div className="absolute bottom-8 right-8 w-24 h-24 border-b-2 border-r-2 border-[var(--gold)]/40 animate-fade-in opacity-0 delay-700" style={{ animationFillMode: 'forwards' }} />
        ...
        <div className="relative z-10 text-center text-white px-4 space-y-8">
          ...
          {hasUrduTitle && (
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif tracking-[0.25em] text-[var(--gold-light)] animate-fade-in-up opacity-0" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
              {settings.bannerTitle}
            </h2>
          )}

          {/* Elegant divider */}
          <div className="flex items-center justify-center gap-4 animate-fade-in-up opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
            <span className="w-16 h-px bg-[var(--gold)]" />
            <span className="text-[var(--gold)]">◆</span>
            <span className="w-16 h-px bg-[var(--gold)]" />
          </div>

          <p className="text-lg sm:text-xl md:text-2xl font-light tracking-[0.15em] max-w-2xl mx-auto leading-relaxed text-gray-200 animate-fade-in-up opacity-0" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>
            {settings.bannerSubtitle}
          </p>

          <div className="pt-6 animate-fade-in-up opacity-0" style={{ animationDelay: '0.9s', animationFillMode: 'forwards' }}>
            <a
              href="#collections"
            ...
            >
              ...
              <span className="relative text-sm tracking-[0.2em] uppercase font-medium">Explore Collection</span>
      ...
      <section id="collections" className="py-28 px-4 sm:px-6 lg:px-8 bg-[var(--background)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <span className="text-[var(--gold)] text-sm tracking-[0.3em] uppercase">Our Finest</span>
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="mt-4 text-gray-500 tracking-wider text-sm">Loading treasures...</p>
            </div>
            ...
            <p className="text-center text-gray-500 tracking-wide">No featured products available yet.</p>
          )}
          ...
          <div className="text-center mt-20">
            ...
            >
              ...
              <span className="relative text-sm tracking-[0.2em] uppercase font-medium">View All Collections</span>
              <svg className="relative w-5 h-5 transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </a>
      ...
      <section id="all-products" className="py-28 px-4 sm:px-6 lg:px-8 bg-[var(--cream)]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <span className="text-[var(--gold)] text-sm tracking-[0.3em] uppercase">Discover More</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif tracking-[0.15em] mt-4 mb-6">
              ALL COLLECTIONS
            </h2>
            <div className="flex items-center justify-center gap-4">
            ...
            {pagination.total > 0 && (
              <p className="text-sm text-gray-500 mt-6 tracking-wider">
                Showing <span className="text-[var(--gold)]">{allProducts.length}</span> of <span className="text-[var(--gold)]">{pagination.total}</span> exquisite pieces
              </p>
            )}
          </div>
          ...
          {loading || productsLoading ? (
            ...
            <p className="text-center text-gray-500 tracking-wide">No products available yet.</p>
          )}
        </div>
      </section>

      {/* About Section */}
      <section id="about" className="py-28 px-4 sm:px-6 lg:px-8 bg-[var(--background)] relative overflow-hidden">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-28 px-4 sm:px-6 lg:px-8 bg-[var(--cream)]">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-[var(--gold)] text-sm tracking-[0.3em] uppercase">Connect</span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif tracking-[0.15em] mt-4 mb-6">
            GET IN TOUCH
          </h2>
          <div className="flex items-center justify-center gap-4 mb-12">
          ...
          <p className="text-lg leading-relaxed text-gray-700 mb-10 max-w-2xl mx-auto">
            Have questions about our collection or looking for something special?
            Our team is here to help you find the perfect piece that speaks to your heart.
          </p>
          ...
          >
            ...
            <span className="relative text-sm tracking-[0.2em] uppercase font-medium">Contact Us on WhatsApp</span>
          </button>
        </div>
      </section>
